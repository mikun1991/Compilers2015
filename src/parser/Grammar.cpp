...
bool Grammar::procedureHeading()
{
	...
	procedureHeading_rec.setType(VoidData);  //procedures don't have a return type
	...
	case MP_PROCEDURE:
		...
		_semanticAnalyser->createTable(procedureHeading_rec.getNextId(), procedureHeading_rec.getType());
		optionalFormalParameterList(optionalFormalParameterList_rec);
		_semanticAnalyser->insertSymbol(optionalFormalParameterList_rec);
		return true;
